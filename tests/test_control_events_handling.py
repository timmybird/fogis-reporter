...
def test_find_existing_event():
    ...
    api_client_mock.report_match_event.return_value = [
        {'matchhandelseid': 457, 'matchhandelsetypid': 32, 'period': 2, 'hemmamal': 1, 'bortamal': 0}
    ]
...
def test_period_start_handling():
    ...
    # Mock the api_client.report_match_event to return a successful response
    api_client_mock.report_match_event.return_value = [{'matchhandelseid': 123, 'matchhandelsetypid': 31, 'period': 1}]
...
def test_update_existing_period_end():
    ...
    # Mock the api_client.report_match_event to return a successful response
    api_client_mock.report_match_event.return_value = [
        {'matchhandelseid': 457, 'matchhandelsetypid': 32, 'period': 1, 'hemmamal': 1, 'bortamal': 0}
    ]
...
def test_update_existing_game_end():
    ...
    match_context_mock.match_events_json = [period_start_event, period_end_event, existing_game_end]
    ...
    # Mock the api_client.report_match_event to return a successful response
    api_client_mock.report_match_event.return_value = [
        {'matchhandelseid': 458, 'matchhandelsetypid': 23, 'period': 2, 'hemmamal': 2, 'bortamal': 1}
    ]
