...
from fogis_reporter import report_results_menu, _report_match_results_interactively, _get_score_input_from_user, _verify_match_results
...
def test_verify_match_results():
    ...
    from fogis_reporter import Scores, Score
...
def test_report_match_results_interactively():
    ...
    with patch('fogis_reporter._get_score_input_from_user', get_score_input_mock):
        with patch('fogis_reporter._verify_match_results', verify_results_mock):
            with patch('fogis_reporter._mark_reporting_finished_with_error_handling', mark_finished_mock):
                # Call the function
                ...
                get_score_input_mock.assert_called_once_with(1, 0, "Team 1", "Team 2", 2, 1)
...
def test_report_results_menu():
    ...
    # Patch the necessary functions
    with patch('fogis_reporter._report_match_results_interactively', report_results_mock):
