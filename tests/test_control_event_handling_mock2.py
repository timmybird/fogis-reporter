...
def test_create_new_events():
    ...
    api_client_mock.report_match_event.return_value = [{'matchhandelseid': 123, 'matchhandelsetypid': 31, 'period': 2}]
    match_context_mock.api_client = api_client_mock
    ...
    def side_effect(event_json):
        ...
        return [{'matchhandelseid': 123, 'matchhandelsetypid': event_json['matchhandelsetypid'], 'period': event_json['period']}]
